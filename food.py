...
def get_dishes_by_mood(user_input):
    ...
    for key, values in filters.items():
        ...
        #print(filtered_df)
    return pprint.pformat(filtered_df[['name', 'ingredients', 'diet', 'prep_time', 'cook_time','flavor_profile','course', 'state', 'region']].to_dict(orient="records"))


print('Get Dishes By Mood: ', (get_dishes_by_mood("I'm feeling really high and want something comforting")))
print('Get Dishes By Region: ', (get_dishes_by_region("Get me all bitter items from North")))